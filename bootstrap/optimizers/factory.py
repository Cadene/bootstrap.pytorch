...
def factory(model, engine):
    ...
    elif 'import' in Options()['optimizer']:
    ...
    if 'lr_scheduler' in Options()['optimizer']:
        optimizer = torch.optim.lr_scheduler.__dict__[Options()['optimizer']['lr_scheduler']['name']](
            optimizer,
            Options()['optimizer']['lr_scheduler']['step_size'],
